...
Write-Host "  Lab 05 Shellshock     → http://www.seedlab-shellshock.com (port 10086)" -ForegroundColor Green
Write-Host ""
Write-Host "Note: Hostnames require entries in C:\Windows\System32\drivers\etc\hosts" -ForegroundColor Yellow
Write-Host "      See each lab's README.md for the exact entries needed." -ForegroundColor Yellow
Write-Host ""
